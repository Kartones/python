...
# TODO: Handle nasty windows characters inserted like the following, which cause encoding errors
# (fixed now by manual replacing at source xmls)
# ’  -> "
# “ -> "
# ” -> "
# … -> ...
...
class BlogEngineToPelican():
    """
    Script to migrate posts from BlogEngine.net to Pelican.
    Read https://blog.kartones.net/post/migrating-from-blogengine-to-pelican for more info.
    """
